...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rack>.freeze, ["~> 1.5", ">= 1.5.2"])
    s.add_runtime_dependency(%q<tilt>.freeze, ["~> 1.3", ">= 1.3.4"])
    s.add_runtime_dependency(%q<rack-protection>.freeze, ["~> 1.4"])
  else
    s.add_dependency(%q<rack>.freeze, ["~> 1.5", ">= 1.5.2"])
    s.add_dependency(%q<tilt>.freeze, ["~> 1.3", ">= 1.3.4"])
